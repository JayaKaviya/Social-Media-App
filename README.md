...
# 🌐 LetsConnect – Social Media Web App

LetsConnect is a full-stack social networking web application that enables users to connect, share posts, and interact in real-time. The platform supports image and text posts, engagement features, and administrative controls.
...
2. Like and unlike friends' posts  
3. Comment on posts  
4. Delete your own comments  
5. Follow and unfollow users  
6. Real-time communication using WebSocket  
7. Admin privileges to delete any post  
...
LetsConnect is designed to simulate core social media functionalities including user interaction, engagement features, and live updates. The application ensures a smooth user experience with dynamic UI updates and real-time interactions.

---

## 🔐 Admin Controls

- Admin can delete any post across the platform.
- Ensures content moderation and platform management.
---
...
![Screenshot 2025-06-19 163935](https://github.com/user-attachments/assets/51958b0a-6950-4ad8-954d-5a25577fe1b4)  <br/> <br/>
...
## Congratulations PopUp After Registration
<img width="1916" height="970" alt="image" src="https://github.com/user-attachments/assets/94d9c145-2551-4f34-b0d8-118f8d663e14" /> <br/> <br/>

## Forgot Password Page 
<img width="1920" height="967" alt="image" src="https://github.com/user-attachments/assets/f94a166f-b5ff-4113-a0ae-27f4531ca99f" /> <br/> <br/>

## Profile Page 
![Screenshot 2025-06-19 164512](https://github.com/user-attachments/assets/1b54c37e-dbe9-46b9-bab1-f156242a7e9e) <br/> <br/>

## Congratualtions PopUp After Profile Updation
<img width="1901" height="969" alt="image" src="https://github.com/user-attachments/assets/fc029168-ed76-49a3-9ffe-b1d8577a8420" /> <br/> <br/>

## Dashboard of Lets Connect app 
![Screenshot 2025-06-19 162630](https://github.com/user-attachments/assets/0b4851b2-f5a0-4c41-a205-c0f3d901d76d) <br/> <br/>
